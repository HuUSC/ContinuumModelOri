...
disp_out = np.linalg.norm( y_ref.at(L/2, H) - (y_ref.at(0, H) + y_ref.at(L, H))/2 )
...
# sol_ig = Function(V, name='IG yeff')
# solve(a == L, sol_ig, bcs=bcs, solver_parameters={'quadrature_degree': '2'})
#
# # Save solution to file
# file = VTKFile("IG_def.pvd")
# aux = Function(V, name='IG yeff')
# x = SpatialCoordinate(mesh)
...
# elastic parameters
# c_1, c_2, d_1, d_2, d_3 = 1.0, 0.5, 0, 0, 5e-3 # working
