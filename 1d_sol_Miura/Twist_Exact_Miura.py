...
sol_d = solve_ivp(ode_rot_d, [0, L], np.identity(3).flatten(), t_eval=tu, args=(omega_u, phi)) # L/lu0
...
sol_l = solve_ivp(ode_rot_l, [0, H], np.identity(3).flatten(), t_eval=tv, args=(omega_v, phi)) #H/lv0
...
sol_t = solve_ivp(ode_rot_t, [0, L], bc_l.at(0, H).flatten(), t_eval=tu, args=(omega_u, phi, H)) #L/lu0
...
sol_r = solve_ivp(ode_rot_r, [0, H], bc_d.at(L, 0).flatten(), t_eval=tv, args=(omega_v, phi, L)) #H/lv0
